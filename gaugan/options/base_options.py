...
class BaseOptions():
    ...
    def gather_options(self, arg_list=None):
        ...
        opt, unknown = parser.parse_known_args(arg_list)
        ...
        # else:
            # opt = parser.parse_args(args=arg_string)
        self.parser = parser
        return opt
    ...
    def parse(self, arg_list=None, save=False):
