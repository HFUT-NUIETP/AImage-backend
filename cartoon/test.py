...
import torch
import numpy as np
from cartoon.models.networks import ResnetGenerator
import argparse
...
class Photo2Cartoon:
    def __init__(self):
        ...
        assert os.path.exists('./cartoon/models/photo2cartoon_weights.pt'), "[Step1: load weights] Can not find 'photo2cartoon_weights.pt' in folder 'models!!!'"
        params = torch.load('./cartoon/models/photo2cartoon_weights.pt', map_location=self.device)
...
def test_main(photo_path, save_path):
