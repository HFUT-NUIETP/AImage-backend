...
def main():
    ...
    parser.add_argument('--model', type=str, default='StegaStamp/saved_models/stegastamp_pretrained')
    parser.add_argument('--image', type=str, default='upload/upload.png')
    parser.add_argument('--images_dir', type=str, default=None)
    parser.add_argument('--result_dir', type=str, default='StegaStamp/data/decode/save/')
    ...
    for filename in files_list:
        ...
        if bitflips != -1:
            ...
            with open(args.result_dir + 'code.txt', 'w+') as f:
                f.write(code)
